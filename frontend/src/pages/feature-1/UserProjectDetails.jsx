        ...
        <div style={{ maxWidth: "760px", margin: "0 auto", padding: "40px 24px" }}>
          <button
            ...
            style={{
              ...
              color: "#a7e87a", fontSize: "14px", fontWeight: "800",
      ...
      <div style={{ maxWidth: "760px", margin: "0 auto", padding: "40px 24px" }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
            ...
            <button
              ...
              onClick={() => { if (!project?._id) return; navigate(`/finance-payments/project/${project._id}`); }}
              style={{
                padding: "11px 20px",
                background: "rgba(213,255,119,0.12)",
                border: "1px solid rgba(213,255,119,0.28)",
                borderRadius: "10px", color: "#c6f06a",
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", marginBottom: "20px" }}
          ...
          <StatCard
            ...
            value={project.expectedMonthlySavings ? formatLKR(project.expectedMonthlySavings) : formatLKR(project.capacityKW * 120 * 25)}
            accent
          />
        </div>
        ...
        {project.description && (
          <div style={{
            ...
            <h3 style={{ fontSize: "11px", fontWeight: "800", color: "rgba(213,229,220,0.5)", letterSpacing: "0.08em", textTransform: "uppercase", margin: "0 0 12px 0" }}>
              Description
            </h3>
            <p style={{ fontSize: "15px", color: "#d5e8da", lineHeight: "1.6", margin: 0 }}>
              {project.description}
            </p>
          </div>
        )}
        ...
        <div style={{
          ...
          {project.startDate && <InfoRow label="Start Date" value={new Date(project.startDate).toLocaleDateString()} />}
          {project.estimatedCompletionDate && <InfoRow label="Est. Completion" value={new Date(project.estimatedCompletionDate).toLocaleDateString()} />}
        </div>
