...
function EmptyState() {
  return (
    <div style={{
      ...
      <p style={{ color: "rgba(255,255,255,0.3)", fontSize: "14px", margin: 0 }}>No projects found for this community.</p>
    </div>
  );
}
...
export default function UserProjects() {
  ...
  return (
    <div style={odPageStyle}>
      ...
      {/* Back Button */}
      <div style={{ maxWidth: "1000px", margin: "0 auto", padding: "20px 16px 0" }}>
        <button
      ...
      <div style={{ padding: "10px 16px 10px" }}>
        <div style={{
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <h1 style={{ fontSize: "clamp(1.8rem,3.2vw,2.8rem)", fontWeight: "900", color: "#fff", lineHeight: 1.05, margin: "0 0 10px", maxWidth: "12ch" }}>
              Energy Projects
            </h1>
            <p style={{ margin: 0, color: "rgba(231,243,237,0.78)", fontSize: "15px", lineHeight: 1.6, maxWidth: "480px" }}>
              Browse, track funding and view details for all community energy projects in your area.
            </p>
          </div>
          <div style={{
      ...
      <div style={{ maxWidth: "1000px", margin: "0 auto", padding: "16px 16px 48px" }}>
        ...
        {!loading && !feedback && (
          <>
            <div style={{ fontSize: "13px", fontWeight: "700", letterSpacing: "0.06em", color: "rgba(213,229,220,0.5)", textTransform: "uppercase", margin: "8px 0 16px" }}>
